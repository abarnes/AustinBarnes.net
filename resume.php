<div class="row normal-margins hidden-block" id="resume">
    <div class="col-sm-7">
        ...
        <ul class="timeline">
            ...
            <li>
                <div class="timelineUnit">
                    <h4>Residential Technology Advisor<span class="timelineDate">2009</span></h4>
                    <h5>Baylor University</h5>
                    <p>Provided technical support to students and faculty, specializing in Mac OS X and linux.</p>
                </div>
            </li>
            <div class="clear"></div>
        </ul>
        ...
        <ul class="timeline">
            <li>
                <div class="timelineUnit">
                    <h4>B.B.A. Baylor Business Fellows, Economics<span class="timelineDate">2009 - 2012</span></h4>
                    <h5>Summa Cum Laude</h5>
                    <h5>Baylor University</h5>
                    <p>Minors in Japanese and Arabic.</p>
                </div>
            </li>
            <div class="clear"></div>
        </ul>

        <h3 class="main-heading"><span>Accomplishments</span></h3>
        <ul class="timeline">
            <li>
                <div class="timelineUnit">
                    <h4>Baylor New Venture Competition<span class="timelineDate">2013</span></h4>
                    <h5>Vendevor</h5>
                    <p>
                        The Vendevor CMO and I won the $25,000 first place prize in the Baylor New Venture Business Plan Competition in 2013 for Vendevor, beating businesses from Harvard, MIT, and dozens of other schools.
                        <br>
                        <a href="http://www.baylor.edu/mediacommunications/news.php?action=story&story=128210" target="_blank">Read News Article</a>
                    </p>
                </div>
            </li>
            <li>
                <div class="timelineUnit">
                    <h4>Nicaragua Clean Water Business Plan<span class="timelineDate">2011-2012</span></h4>
                    <h5>Baylor University</h5>
                    <p>Wrote a business plan to provide clean water to rural Nicaraguans after conducting in-country research.  Presented to 3M executives for funding in 2011, and currently continued by Baylor University marketing students.</p>
                </div>
            </li>
            <li>
                <div class="timelineUnit">
    ...
    <div class="col-sm-5">
        ...
        <ul class="skills">
            ...
            <li>
                <h4>Deutsch <span style="font-size:90%;font-weight: lighter;">German</span></h4>
                <span class="rat6"></span>
            </li>
            <li>
                <h4>日本語　<span style="font-size:90%;font-weight: lighter;">Japanese</span></h4>
                <span class="rat4"></span>
            </li>
            <li>
                <h4>Русский <span style="font-size:90%;font-weight: lighter;">Russian</span></h4>
                <span class="rat3"></span>
            </li>
            <li>
                <h4>العربية<span style="font-size:90%;font-weight: lighter;"> Arabic</span></h4>
